...
export type View = 'records' | 'log' | 'graph' | 'import' | 'settings' | 'messages' | 'people' | 'multiuser' | 'api' | 'members' | 'branch' | 'nl';

const VIEWS = new Set<string>(['records', 'log', 'graph', 'import', 'settings', 'messages', 'people', 'multiuser', 'api', 'members', 'branch', 'nl']);
